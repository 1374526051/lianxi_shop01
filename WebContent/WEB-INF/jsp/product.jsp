...
<div class="container productContent">
		...
		<div class="span18 last">
			...
			<div class="info">
				...
				<!-- 购物车 -->
				<form action="${pageContext.request.contextPath }/cart/addCartItem.action" method="post">
					<div class="action">
