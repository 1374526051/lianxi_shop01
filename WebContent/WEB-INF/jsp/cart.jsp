	...
	<div class="container cart">
		<div class="span24">
			<div class="step step1">
				...
				<table>
					...
					<c:forEach var="cartItem" items="${cart.cartItems }">
						<tr>
							...
							<td>
								<a href="${pageContext.request.contextPath }/cart/remove.action?pid=${cartItem.product.pid}" class="delete">删除</a>
							</td>
						</tr>
				...
				<div class="bottom">
					<a href="${pageContext.request.contextPath }/cart/clear.action" id="clear" class="clear">清空购物车</a>
					<a href="./会员登录.htm" id="submit" class="submit">提交订单</a>
				</div>
				</c:if>
				<c:if test="${cart.cartItems.size()==0 }">
				<div class="bottom">
					<font color="red" size="5">亲！您的购物车空空如也！！赶紧去购物吧！！！！</font>
				</div>
				</c:if>
		</div>
	</div>
