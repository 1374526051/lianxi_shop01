...
<script type="text/javascript">
	...
	function xiaoyan(){
		...
		$.ajax({
			...
			type:'post',
			url:"${pageContext.request.contextPath}/user/xiaoyan.action",
	...
	//验证码
	function change(){
		//获取img标签对象  加入时间戳 防止走缓存
		document.getElementById("captchaImage").src = "${pageContext.request.contextPath}/checkImg.action?"+new Date().getTime();
	}
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm"  method="post" action="${pageContext.request.contextPath }/user/regist.action" onsubmit="return fun1()">
						<table>
							<tbody><tr>
								<th>
								...
								<td>
									<input type="text" id="username" name="username" class="text" maxlength="20" onblur="xiaoyan()">
									<font color="red"><span id=sid></span></font>
								</td>
							</tr>
							<tr>
								<th>
							...
							<tr>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="captcha" name="captcha" class="text captcha" maxlength="4" autocomplete="off"><img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/checkImg.action" onclick="change()" title="点击更换验证码">
